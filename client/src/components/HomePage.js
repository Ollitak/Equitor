    ...
    <div>
      <Segment style={{ padding:"2em" }} vertical>
        <Grid stackable container verticalAlign='middle'>
          <Grid.Row columns={2}>
            <Grid.Column width={7}>
              <Header as="h1" style={{ fontSize:"2.5em" }}>{"Equitor"}</Header>
          ...
          <Grid.Row columns={1}>
            <Grid.Column textAlign="center">
              <Header as="h1" style={{ fontSize:"2.5em", marginBottom:"1em" }}>Happy users</Header>
          ...
          <Grid.Row columns={1} style={{ marginTop:"4em" }}>
            <Grid.Column textAlign="center">
              <p style={{ fontSize: "1.2em", fontStyle:"italic" }}>{"' Never seen anything like this '"}</p>
          ...
          <Grid.Row columns={2} style={{ marginBottom:"4em" }}>
            <Grid.Column width={7} floated="left">
              <Image bordered rounded size="large" src="https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"></Image>
            </Grid.Column>
            <Grid.Column width={8}>
              <Header as="h1" style={{ fontSize:"2.5em" }}>{"TBD"}</Header>
              <p style={{ fontSize:"1.2em" }}>{placeholder}</p>
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Segment>
      <Segment inverted style={{ borderRadius:0, minHeight:50, marginTop:"0" }}>
      </Segment>
    </div>
  );
};
